...
public class DaoVeiculo{
    ...
    public ArrayList<Veiculo> listarTodos(){
        ...
        try{
            ...
            ResultSet rs = stm.executeQuery("SELECT * FROM tb_veiculos ORDER BY codigo");
    ...
    public ArrayList<Veiculo> listarTodosFiltro(String campo, String filtro){
        ArrayList<Veiculo> resultados = new ArrayList<>();
        ...
        try{
            ...
            ResultSet rs = stm.executeQuery("SELECT * FROM tb_veiculos WHERE " + campo + " LIKE '%" + filtro + "%' ORDER BY codigo;");
